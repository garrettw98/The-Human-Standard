# The Human Standard: Audience-Specific Talking Points
## Tailored Messages for Key Constituencies

---

## Introduction

The Human Standard appeals to different audiences for different reasons. This guide provides tailored talking points for each major constituency, emphasizing the aspects most relevant to their values and concerns.

**Core Principle**: Never misrepresent the policy. Emphasize different aspects; don't contradict yourself across audiences.
...
**On Unions:**
> "The Human Standard doesn't replace unions—it strengthens them. When workers have economic security, they can organize without fear. They can strike without starvation. They can demand fair treatment from a position of strength, not desperation."

### Avoid
- Suggesting unions are obsolete
- Implying workers should just accept automation
...
- Ignoring real concerns about labor markets
- Promising things we don't deliver

### Proof Points
- Stockton SEED pilot showed increased local business activity
- Alaska PFD correlates with strong small business formation
- Consumer spending multiplier is highest for lower incomes

---

## 3. Tech Workers and Engineers

### Their Core Concerns
- Building meaningful technology
- Ethical implications of AI
- Job market for tech roles
...
**Opening:**
> "You build technology that changes the world. The Human Standard ensures that change is for the better—for everyone, not just shareholders."

**On Purpose:**
> "Most of you got into tech to build things that help people. But you've watched your creations be used to surveil, manipulate, and displace. The Human Standard creates a framework where technology serves humanity. Your work can be something you're proud of again."

**On Open Source:**
> "Government AI should be open source. Period. That's transparency, accountability, and collaboration—the values the tech community was built on. The Human Standard mandates open source for government AI and encourages it everywhere else."

**On Innovation:**
> "We're not slowing down innovation—we're redirecting it. R&D is exempt from automation taxes. Safety improvements get credits. Accessibility technology is fully exempt. We want more innovation, just innovation that lifts everyone up."
...
- Suggesting tech workers are the problem
...
## 4. Libertarians and Classical Liberals
...
**On CBDC:**
> "Central Bank Digital Currencies are surveillance tools. Every transaction tracked, potentially controlled. The Human Standard explicitly prohibits retail CBDCs. Your money, your business."

**On Markets:**
> "We're not replacing markets—we're letting them work better. When workers have exit options, employment contracts become more voluntary. When consumers have money, markets clear more efficiently. When AI decisions are transparent, market participants have better information."
...
- Ignoring legitimate tax concerns
- Sounding like central planners
...
**Opening:**
> "Eliminate poverty. Hold AI accountable. Make corporations pay their fair share. The Human Standard is the progressive economic agenda for the 21st century."
...
- Ignoring intersectional impacts
...
## 6. Conservatives and the Right

### Their Core Concerns
- Family stability
- Local communities
- Work ethic and dignity
...
**On Work Ethic:**
> "$24,000/year doesn't buy you a comfortable life. It keeps you alive. Most people will absolutely keep working—they'll just have more options about what kind of work. And when people can afford to take risks, you get more entrepreneurs, more innovation, more of the economic dynamism that made America great."
...
- Sounding like government knows best
- Ignoring work ethic concerns
...
- Sounding like old politicians

### Proof Points
- Youth unemployment statistics
- Student debt figures
- Generational wealth comparisons
- Startup success rates with capital access
...
**On Dignity:**
> "After a lifetime of work, you deserve dignity. Not means-testing. Not bureaucrats judging your worthiness. A guaranteed income that lets you live with independence."

### Avoid
- Any hint of cutting Social Security
- Suggesting retirees don't understand technology
- Ignoring healthcare concerns

### Proof Points
- Social Security stacking language in legislation
- Senior poverty reduction projections
- Caregiver economic data
- Inflation analysis
...
- Lack of services
- Being forgotten by politicians
...
- Promising things only for cities

### Proof Points
- Alaska PFD impact on rural communities
- Economic multiplier in underserved areas
- Rural entrepreneurship with capital access
- Cost of living adjusted benefit analysis
...
- Suggesting VA replacement
- Hollow patriotic rhetoric without substance

### Proof Points
- VA benefits stacking language in legislation
- Military spouse unemployment statistics
- Veteran transition challenge data
- Alaska veteran outcomes with PFD

---

## Cross-Audience Themes

### Universal Messages That Work Everywhere

1. **Economic Security**: Everyone wants stability; frame it to each audience
2. **Dignity**: Work, choice, independence—valued across the spectrum
3. **Fairness**: The automation economy should benefit everyone
4. **Simplicity**: No bureaucracy, no means-testing, just direct support
5. **Future-Focused**: Preparation for technological change, not nostalgia

### Messages to Handle Carefully

1. **Taxes**: Emphasize "automation" and "robots" paying, not people
2. **Government**: Acknowledge distrust; emphasize simplicity and limits
3. **Work**: Never sound like you don't value work; redefine as meaningful activity
4. **Redistribution**: Frame as "dividend" or "share," not "redistribution"
5. **Innovation**: Never sound anti-technology; be pro-human-technology balance
...
*This guide enables consistent, authentic messaging across diverse audiences while maintaining core message integrity.*
