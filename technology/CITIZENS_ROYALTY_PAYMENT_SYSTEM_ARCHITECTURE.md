...
CREATE TABLE recipients (
    ...
    citizens_royalty_id VARCHAR(12) UNIQUE NOT NULL,  -- Public identifier
...
servers:
  - url: https://api.citizensroyalty.gov/v1
...
package citizens_royalty.payment;

option go_package = "github.com/treasury/citizens_royalty/payment";
